...
import { AiOutlineEdit, AiOutlineDelete, AiOutlinePlus, AiOutlineMinus } from "react-icons/ai";
...
export default function AddressPage() {
  ...
  const closePopup = () => {
    setShowPopup(false);
    // Optionally reset the steps or perform other actions
    setStep(1);
  };
  ...
  const cartItems = [
    {
      id: 1,
      src: img13, // Replace with actual image source
      title: "Dr. Sheth's Kesar & Kojic Acid Sunscreen With SPF 50+ PA++++ (80 g)",
...
//   const [editingAddress, setEditingAddress] = useState<any>(null);
  ...
  const handleEditAddress = (index) => {
    // Set the selected address as the one being edited
...
//   };
      ...
      <div className="w-full bg-white shadow-lg rounded-xl p-8">
        ...
        <div className="flex justify-end items-center mb-8 w-full">
          <div className="flex justify-between items-center w-full max-w-5xl">
            {["Signup", "Address", "Payment"].map((label, index) => (
              <div
                key={index}
  ...
  <div className="p-4 md:p-6 bg-white border-gray-200 rounded-lg shadow-sm">
    ...
    <h2 className="text-lg md:text-xl font-semibold text-gray-900 mb-2">
      My Bag <span className="text-sm text-gray-600">({cartItems.length} items)</span>
    </h2>
      ...
      >
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <p className="text-sm text-green-600 font-medium mt-1">{item.coupon}</p>
        ...
        <div className="flex items-center space-x-4">
          ...
          <p className="text-lg font-medium text-gray-800">{item.quantity}</p>
          <button
            className="bg-gray-200 p-2 rounded-full hover:bg-gray-300"
            ...
            {addresses
              ...
              .map((address, index) => (
                <div
                  ...
                  onClick={() => setSelectedAddress(address)} // Set the selected address
                >
                  ...
                  <p className="text-sm text-gray-600 mt-1">Mobile: {address.mobile}</p>
            ...
            <div className="mt-8">
              ...
              <div className="mt-4 flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  onClick={
                    editingAddress ? handleSaveEditedAddress : handleAddAddress
                  }
                >
...
{step === 3 && selectedAddress &&(
  <>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs md:text-sm text-gray-500">Qty: 1</p>
                </div>
              </div>
              <p className="text-sm font-semibold text-gray-800">₹ 499</p>
            </div>
          </div>
        </div>
    ...
    <p className="text-sm text-gray-600 mt-1">Mobile: {selectedAddress.mobile}</p>
  </div>
