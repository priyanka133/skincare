  ...
  return (
    ...
    <div>
       <header className="bg-[#FDECE3] bg-custom bg-cover bg-center relative py-32 flex items-center justify-center flex-col">
          ...
          <div className="relative z-10 text-center">
            ...
            <h1 className="text-[#5A3726] text-4xl font-bold mt-2">Contact Us</h1>
          </div>
        </header>
    </div>
    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-50">
      <div className="w-full max-w-4xl p-8 bg-white shadow-md rounded-md">
        <h1 className="text-2xl font-bold text-center mb-6 text-[#5A3726] ">Get In Touch</h1>
    ...
    <div className="py-20 bg-white">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 mt-2">
          At Beautify we are here to help you anytime to assist in answering any
          of your questions so you can make the best decision regarding your
          salon journey with us.
        </p>
      </div>
